...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $module->initialize();
    $module->getWorkflow()->updateTask(filter_var($_POST['user_uuid'], FILTER_SANITIZE_STRING), filter_var($_POST['task_uuid'], FILTER_SANITIZE_STRING), filter_var($_POST['type'], FILTER_SANITIZE_STRING));
}
...
<div class='row' style="margin-bottom: 20px;">
    <div class='col-lg-6'>
        <div class='card text-center' style="background-color: rgb(241,241,241)">
            ...
            <div class='card-body' data-task-uuid='<?php echo $image['task_uuid']; ?>'
