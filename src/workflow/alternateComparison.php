...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $module->alternateInitialize();
    $module->getWorkflow()->updateTaskSimple(
    ...
    <div class='col-lg-12'>
        <div class='card' style="background-color: rgb(241,241,241)">
            ...
            <div class='card-content text-center' style="margin-top:10px;">
                <img class="img" src="<?php echo $image['photo_binary']; ?>"
                    ...
                    <div class="form-row">
                        <div class="form-group readable-box col-md-3">
                            <label>
                                ...
                                <i class="far fa-question-circle" data-toggle="tooltip"
                                   title="Is this picture readable?"></i>
                            </label>
                        ...
                        <div class="form-group reagents-box col-md-3">
                            <label>
                                ...
                                <i class="far fa-question-circle" data-toggle="tooltip"
                                   title="Have the majority of the reagents dropped into the result zone (beyond one small droplet)?"></i>
                            </label>
                            <div class="form-check">
                        ...
                        <div class="form-group disc-box col-md-3">
                            <label>
                                <strong>Disc</strong>
                                <i class="far fa-question-circle" data-toggle="tooltip"
                                   title="Is the cellulose disc visible and is it touching the tip of the capillary?"></i>
                            </label>
                            <div class="form-check">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group volume-box col-md-3">
                            <label>
                                ...
                                <i class="far fa-question-circle" data-toggle="tooltip"
                                   title="Look at the zone above the black rubber grommet/cap (result zone).Is there enough (~15mm) colored liquid at the result zone?"></i>
                            </label>
                            <div class="form-check">
                        ...
                        <div class="form-group seal-box col-md-3">
                            <label>
                                <strong>Seal</strong>
                                <i class="far fa-question-circle" data-toggle="tooltip"
                                   title="Is the clear seal pushed up and visible in the readout zone?"></i>
                            </label>
                            <div class="form-check">
